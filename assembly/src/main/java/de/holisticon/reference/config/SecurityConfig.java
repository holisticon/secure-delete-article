...
public class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(KeycloakClientRequestFactory keycloakClientRequestFactory) {
        ...
        // see https://blog.codecentric.de/2017/09/keycloak-und-spring-security-teil-3-kommunikation-via-keycloakresttemplate/
    ...
    http
        ...
        .and()
            .csrf().disable() // TODO integrate CSRF protection into angular frontend
            .cors()
        .and()
